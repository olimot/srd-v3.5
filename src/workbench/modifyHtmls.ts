...
function modifyHtmls<TReturn = void>(
  inDir: string,
  outDir: string,
  pageFunction: () => TReturn,
): Promise<Record<string, TReturn>>;
function modifyHtmls<TArg extends SerializableOrJSHandle, TReturn = void>(
  inDir: string,
  outDir: string,
  pageFunction: (arg: TArg) => TReturn,
  arg: TArg,
): Promise<Record<string, TReturn>>;
async function modifyHtmls<TArg extends SerializableOrJSHandle, TReturn = void>(
  inDir: string,
  outDir: string,
  pageFunction: (arg?: TArg) => TReturn,
  arg?: TArg,
